...
function verify_signup(){  
    ...
    xmlHttp.open("POST", "../controller/SignUpHandle.php", true);
    //post方式需要自己设置http的请求头  
    xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");  
    //post方式发送数据  
    xmlHttp.send("userName="+userName+"&age="+age+"&sex="+sex+"&password="+ password+"&email="+ email+"&telephone="+telephone+"&type="+type+"&height="+height+"&weight="+weight);
    //4.发送数据，开始和服务器端进行交互  
